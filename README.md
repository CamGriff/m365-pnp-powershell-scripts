...
### Navigation
- [Create-Navigation.ps1](./site-navigation/create-site-navigation.ps1) — Create SharePoint site navigation nodes programmatically | [Full docs](https://www.camerongriffiths.com/scripts/createnavigation)
...
- [Find-Base-List-Template-ID.ps1](https://github.com/CamGriff/m365-pnp-powershell-scripts/blob/main/lists-libraries/findBaseListTemplateID.ps1) — Finds the base template ID for all lists and libraries in a SharePoint site collection, useful for identifying list types programmatically | [Full docs](https://www.camerongriffiths.com/scripts/findBaseListTemplateID)
- ### Message Banner
