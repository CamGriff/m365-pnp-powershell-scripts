...
- [Find-Base-List-Template-ID.ps1](./lists-libraries/findBaseListTemplateID) — Finds the base template ID for all lists and libraries in a SharePoint site collection, useful for identifying list types programmatically | [Full docs](https://www.camerongriffiths.com/scripts/findBaseListTemplateID)
- ### Message Banner
